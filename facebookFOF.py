...
# driver = webdriver.Chrome(driver_path='/home/dexter/wokspace/chrome-driver/chromedriver', chrome_options=chrome_options ,service_args=['--verbose', '--log-path=/tmp/chromedriver.log'])
